...
@Autonomous(name = "Left_Side_Blue_Auto")
public class Left_Side_Blue_Auto extends LinearOpMode {
    //RED + RIGHT
    //66,
    /**
    ...
    public void runOpMode() {
        ...
        //move to junction
        int returnDistance = robot.forwardDrive(0.5, 1550,4,12)+50;
        robot.setClawPosition(Constants.CLAW_CLOSED);
        sleep(750);
        robot.setSlidePosition(Constants.LOW_POSITION);
        sleep(500);
        robot.setWristPosition(Constants.WRIST_UP);
        turret.setTurretPosition(Constants.TURRET_RIGHT);
